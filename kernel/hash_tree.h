...
int hash_tree_add(struct first_level_bucket* map, u64 xxhash, u8* blake2b,
                  struct page_metadata* metadata);
struct page_metadata* hash_tree_lookup(struct first_level_bucket* map,
                                       u64 xxhash, u8* blake2b);
struct page_metadata* hash_tree_get_or_create(struct first_level_bucket* map,
                                              u64 xxhash, u8* blake2b,
                                              struct page_metadata* metadata);
